...
/**
 * This class contains all methods for searching through collections, persons, and interactions.
 *
 */
public class SearchUtil {
	 ...
	 * 
	 * @param query the search query
	 * @return searchInteractionsResultsList the list of search interaction results 
	 */
